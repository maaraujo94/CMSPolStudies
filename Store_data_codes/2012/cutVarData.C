// code to plot the cut variables for the data
/* variables to plot
- single muon pT, eta
...
void cutVarData()
{
  ...
  tree->Add("/eos/user/m/maaraujo/Jpsi2012/Data/flat_tuple_r2012B_MuPk_jpsi_v8_skim.root");
  tree->Add("/eos/user/m/maaraujo/Jpsi2012/Data/flat_tuple_r2012C_MuPk_jpsi_v8_1_skim.root");
  tree->Add("/eos/user/m/maaraujo/Jpsi2012/Data/flat_tuple_r2012D_MuPk_jpsi_v8_1_skim.root");
  ...
  TH1D *h_muPpT  = new TH1D("h_muPpT",  "data muon pT",            100, 0, 70);
  ...
  TH1D *h_JMass  = new TH1D("h_JMass",  "data Jpsi mass",          100, 2.5, 3.5);
  TH1D *h_JPt    = new TH1D("h_JPt",    "data Jpsi pT",            100, 0, 90);
