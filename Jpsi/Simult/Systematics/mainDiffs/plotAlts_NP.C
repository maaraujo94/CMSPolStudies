...
void plotAlts_NP()
{
  ...
  // 0 - get Run2 results
  TFile *fIndB_c = new TFile("../deltaR/files/finalFitRes_NP.root");
  ...
  fl1->SetTitle("non-prompt #Delta#lambda_{#theta} (muon eff |#eta|<0.2)");
  ...
  flE->SetTitle("non-prompt #Delta#lambda_{#theta} (muon eff 0.2<|#eta|<0.3)");
  ...
  c->SaveAs("plots/lthNP_absDiff_eta.pdf");
  c->Clear();
  ...
  fl12->SetTitle("non-prompt #Delta#lambda_{#theta} (#rho factor)");
  ...
  c->SaveAs("plots/lthNP_absDiff_rho.pdf");
  c->Clear();
  ...
  fl2->SetTitle("non-prompt #Delta#lambda_{#theta} (2017-2018)");
  ...
  c->SaveAs("plots/lthNP_absDiff_Y.pdf");
  c->Clear();
