...
void plotModel()
{
  ...
  fl1->SetTitle("prompt #Delta#lambda_{#theta} (varying #alpha)");
  ...
  fl2->SetTitle("prompt #Delta#lambda_{#theta} (varying N_{bkg})");
  ...
  flNP1->SetTitle("non-prompt #Delta#lambda_{#theta} (varying #alpha)");
