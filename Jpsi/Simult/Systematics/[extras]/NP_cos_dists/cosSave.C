void cosSave()
{
  ...
  TH2D *rNP1Hist_ab = new TH2D("rNP1H_ab", "Full Data/MC", 20, 0, 1., nPtBins, ptBins);
  rNP1Hist_ab = (TH2D*)NP1Hist_ab->Clone("rNP1H_ab");
  rNP1Hist_ab->Sumw2();
  rNP1Hist_ab->Divide(mcHist_ab);
  rNP1Hist_ab->SetTitle("Full Data/MC");

  TH2D *rNP2Hist_ab = new TH2D("rNP2H_ab", "Full Data/MC", 20, 0, 1., nPtBins, ptBins);
