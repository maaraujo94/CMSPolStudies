...
void plotRes()
{
  ...
  leg->AddEntry(graph_lth[2], "prompt J/#psi", "pl");
  leg->Draw();
  ...
  TGraphErrors *graph_lthB = (TGraphErrors*)finB->Get("graph_lambda_J");
  finB->Close();
  ...
  graph_lth[2]->SetLineColor(kBlue);
  graph_lth[2]->SetMarkerColor(kBlue);
  ...
  leg2->AddEntry(graph_chi[2], "Prompt J/#psi", "pl");
  leg2->Draw();
