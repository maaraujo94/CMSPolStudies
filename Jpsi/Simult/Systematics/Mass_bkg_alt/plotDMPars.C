...
void plotDMPars()
{
  ...
  double parmin[] = {0,    7e0, 3090, 0,   32, 2.0, 1.3, 100,   7e0, 0.,  0,   0};
  double parmax[] = {100., 2e4, 3100, 200, 46, 3.0, 2.3, 300, 3e4, 15., 100, 100};
  ...
  TH2D *h_d2d = new TH2D();
  TFile *finh = new TFile("../../bkgFits/files/mStore.root");
  ...
  for(int i_p = 0; i_p < 10; i_p++) {
    ...
    // mixed free-constant - alpha
      ...
      g_par_s[0][i_p]->SetFillColorAlpha(pc[0], 0.5);
