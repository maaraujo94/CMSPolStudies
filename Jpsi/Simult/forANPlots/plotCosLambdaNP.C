void plotCosLambdaNP()
{
  ...
  TFile *finL = new TFile("../NP_fit/files/LSB_fitres.root");
  ...
  TFile *finR = new TFile("../NP_fit/files/RSB_fitres.root");
  ...
  c->SaveAs("plots/bkgCosthNP/LSB_l2.pdf");
  c->Clear();
  ...
  c->SaveAs("plots/bkgCosthNP/LSB_l4.pdf");
  c-> Clear();
  ...
  c->SaveAs("plots/bkgCosthNP/RSB_l2.pdf");
  c->Clear();
  ...
  c->SaveAs("plots/bkgCosthNP/RSB_l4.pdf");
  c->Clear();
  ...
  c->SaveAs("plots/bkgCosthNP/LSB_fixed_l2.pdf");
  c->Clear();
  ...
  c->SaveAs("plots/bkgCosthNP/LSB_fixed_l4.pdf");
  c-> Clear();
  ...
  c->SaveAs("plots/bkgCosthNP/RSB_fixed_l2.pdf");
  c->Clear();
  ...
  c->SaveAs("plots/bkgCosthNP/RSB_fixed_l4.pdf");
