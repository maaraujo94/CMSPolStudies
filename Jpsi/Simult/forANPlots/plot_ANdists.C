...
void plot_ANdists()
{
  ...
  lcy.DrawLatex(0.875, 2.75e5, "Low-p_{T}");
  lcy.SetTextColor(coly[1]);
  lcy.DrawLatex(0.875, 2.5e4, "Mid-p_{T}");
  lcy.SetTextColor(coly[2]);
  lcy.DrawLatex(0.875, 5e3, "High-p_{T}");
  ...
  lcys.DrawLatex(0.875, 2.75e5, "Low-p_{T}");
  lcys.SetTextColor(coly[1]);
  lcys.DrawLatex(0.875, 2.5e4, "Mid-p_{T}");
  lcys.SetTextColor(coly[2]);
  lcys.DrawLatex(0.875, 5e3, "High-p_{T}");
