...
void plot_ANdists()
{
  ...
  lcy.DrawLatex(0, 1.7e5, "#minus Peak data");
  lcy.DrawLatex(0, 1.2e5, "-- MC");
  ...
  lcys.DrawLatex(0, 9e4, "#minus Peak data");
  lcys.DrawLatex(0, 6e4, "-- scaled MC");

  lcys.SetTextColor(coly[0]);
  lcys.DrawLatex(-1, 1.5e5, "Low p_{T}");
  lcys.SetTextColor(coly[1]);
  lcys.DrawLatex(-1, 9e4, "Mid p_{T}");
  lcys.SetTextColor(coly[2]);
  lcys.DrawLatex(-1, 6e4, "High p_{T}");
  lcys.SetTextColor(coly[3]);
  lcys.DrawLatex(-1, 4e4, "Highest p_{T}");
  ...
  lclt.DrawLatex(300, 2.5e6, "Data:");
  lclt.SetTextColor(colpt[1]);
  lclt.DrawLatex(300, 1.6e6, "low p_{T}");
  lclt.SetTextColor(colpt[2]);
  lclt.DrawLatex(300, 1e6, "mid p_{T}");
  lclt.SetTextColor(colpt[3]);
  lclt.DrawLatex(300, 6e5, "high p_{T}");
  lclt.SetTextColor(colpt[4]);
  lclt.DrawLatex(300, 3.5e5, "highest p_{T}");
  ...
  lclts.DrawLatex(300, 1.6e6, "low p_{T}");
  lclts.SetTextColor(colpt[2]);
  lclts.DrawLatex(300, 1e6, "mid p_{T}");
  lclts.SetTextColor(colpt[3]);
  lclts.DrawLatex(300, 6e5, "high p_{T}");
  lclts.SetTextColor(colpt[4]);
  lclts.DrawLatex(300, 3.5e5, "highest p_{T}");
