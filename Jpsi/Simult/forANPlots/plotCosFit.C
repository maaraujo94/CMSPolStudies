...
void plotCosFit()
{
  ...
  for(int i = 0; i < nBinsY; i++) {
    ...
    lcb1.DrawLatex(0.15, h_rat1d2[0][i]->GetMaximum()*0.75, "PRS/MC");
    ...
    //lcb1.DrawLatex(0.15, h_rat1d2[1][i]->GetMaximum()*1.2, "f_{NP}*(non-prompt J/#psi)/MC");
    ...
    //lcb1.DrawLatex(0.15, h_rat1d2[3][i]->GetMaximum()*1.1, "f_{Bg}*Bg/MC");
