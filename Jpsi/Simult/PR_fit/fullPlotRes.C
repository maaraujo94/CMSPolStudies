...
void fullPlotRes()
{
  ...
  TFile *fIn = new TFile("files/bkgSubRes_full.root");
  TH2D* rHist;
  ...
  TFile *fInd = new TFile("files/finalFitRes_full.root");
  ...
  c->SaveAs("plots/ratioFinal_full/par_lth.pdf");
  c->Clear();
  ...
  c->SaveAs("plots/ratioFinal_full/par_lth_F.pdf");
  c->Clear();
  ...
  c->SaveAs("plots/ratioFinal_full/par_A.pdf");
  c->Clear();
  ...
  c->SaveAs("plots/ratioFinal_full/par_chiP.pdf");
  c->Clear();
  c->Destructor();
