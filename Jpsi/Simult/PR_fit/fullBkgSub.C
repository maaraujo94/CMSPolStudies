...
void fullBkgSub()
{
  ...
  TFile *inNP = new TFile("../NP_fit/files/bkgSubRes_full.root");
  ...
  TFile *inBkg = new TFile("files/bkgCosModel_full.root");
  ...
  // prepare output
  TFile *fout = new TFile("files/bkgSubRes_full.root", "recreate");
