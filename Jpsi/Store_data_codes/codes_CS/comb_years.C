...
void comb_years()
{
  ...
  // PART 1 : the data
  TFile *fData = new TFile("../dataS_cosCS.root", "recreate");
  ...
  TFile *finD7 = new TFile("../data17_cosCS.root");
  ...
  TFile *finD8 = new TFile("../data18_cosCS.root");
  ...
  TFile *fMC = new TFile("../MCS_cosCS.root", "recreate");
  ...
  // open files and read TTrees - 2017
  TFile *finM7 = new TFile("../MC17_cosCS.root");
  ...
  // open files and read TTrees - 2018
  TFile *finM8 = new TFile("../MC18_cosCS.root");
  ...
  TFile *fMCh = new TFile("../MChS_cosCS.root", "recreate");
  ...
  // open files and read TTrees - 2017
  TFile *finMh7 = new TFile("../MCh17_cosCS.root");
  ...
  // open files and read TTrees - 2018
  TFile *finMh8 = new TFile("../MCh18_cosCS.root");
  ...
  TFile *fMCvh = new TFile("../MCvhS_cosCS.root", "recreate");
  ...
  // open files and read TTrees - 2017
  TFile *finMvh7 = new TFile("../MCvh17_cosCS.root");
  ...
  // open files and read TTrees - 2018
  TFile *finMvh8 = new TFile("../MCvh18_cosCS.root");
  ...
  /*  TFile *fMCO = new TFile("../MCOS_cosCS.root", "recreate");
  ...
  // open files and read TTrees - 2017
  TFile *finMO7 = new TFile("../MC17_old_cosCS.root");
  ...
  // open files and read TTrees - 2018
  TFile *finMO8 = new TFile("../MC18_old_cosCS.root");
