...
void ang_MC()
{
  ...
  // 2017 tree
  TFile *fin7 = new TFile("../orig_files/MC/filtered-all-psi-mc-UL17-25_46v1.root");
  ...
  TFile *fout7 = new TFile("../MC17_cosCS.root", "recreate");
  ...
  // 2018 tree
  TFile *fin8 = new TFile("../orig_files/MC/filtered-all-psi-mc-UL18-25_46v2.root");
  ...
  TFile *fout8 = new TFile("../MC18_cosCS.root", "recreate");
