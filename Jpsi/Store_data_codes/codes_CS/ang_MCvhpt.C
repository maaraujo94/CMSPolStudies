// code that runs over MC (very high pT), applies all cuts and saves a root file with Jpsi pT, y and mass + costheta_HX
...
double *cos_psi(TLorentzVector *psi, TLorentzVector *mu, TLorentzVector *beam, TLorentzVector *targ)
{
  ...
  TVector3 beam_targ_bisect  = ( beam_direction_psi - targ_direction_psi ).Unit();
  ...
  TVector3 newZaxis = beam_targ_bisect;
...
void ang_MCvhpt()
{
  ...
  // 2017 tree
  TFile *fin7 = new TFile("../orig_files/MC/filtered-all-psi-mc-LOCAL17-veryhighpt.root");
  ...
  TFile *fout7 = new TFile("../MCvh17_cosCS.root", "recreate");
  ...
  // 2018 tree
  TFile *fin8 = new TFile("../orig_files/MC/filtered-all-psi-mc-LOCAL18-veryhighpt.root");
  ...
  TFile *fout8 = new TFile("../MCvh18_cosCS.root", "recreate");
