// code that runs over data, applies all cuts and saves a root file with Jpsi pT, y, mass and lts + costheta_CS
...
void ang_data()
{
  ...
  // 2017 tree
  TFile *fin7 = new TFile("../orig_files/Data/filtered-all-psi-UL17.root");
  ...
  TFile *fout7 = new TFile("../data17_cosCS.root", "recreate");
  ...
  // 2018 tree
  TFile *fin8 = new TFile("../orig_files/Data/filtered-all-psi-UL18.root");
  ...
  TFile *fout8 = new TFile("../data18_cosCS.root", "recreate");
