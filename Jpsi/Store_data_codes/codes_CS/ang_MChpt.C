...
void ang_MChpt()
{
  ...
  // 2017 tree
  TFile *fin7 = new TFile("../orig_files/MC/filtered-all-psi-mc-LOCAL17-highpt.root");
  ...
  TFile *fout7 = new TFile("../MCh17_cosCS.root", "recreate");
  ...
  // 2018 tree
  TFile *fin8 = new TFile("../orig_files/MC/filtered-all-psi-mc-LOCAL18-highpt.root");
  ...
  TFile *fout8 = new TFile("../MCh18_cosCS.root", "recreate");
