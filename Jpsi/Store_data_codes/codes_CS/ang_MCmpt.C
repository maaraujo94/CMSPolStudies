// code that runs over MC (mid pT), applies all cuts and saves a root file with Jpsi pT, y and mass + costheta_HX
...
void ang_MCmpt()
{
  ...
  // 2017 tree
  TFile *fin7 = new TFile("../orig_files/MC/filtered-all-psi-mc-LOCAL17-40_52v1.root");
  ...
  TFile *fout7 = new TFile("../MCm17_cosCS.root", "recreate");
  ...
  // 2018 tree
  TFile *fin8 = new TFile("../orig_files/MC/filtered-all-psi-mc-LOCAL18-40_52v2.root");
  ...
  TFile *fout8 = new TFile("../MCm18_cosCS.root", "recreate");
