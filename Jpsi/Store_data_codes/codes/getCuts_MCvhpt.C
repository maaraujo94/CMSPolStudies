// code to plot the cut variables for the 2018 Jpsi MC (very high pT)
/* variables to plot
- single muon pT, eta
- dimuon mass, pT, y
*/
...
void getCuts_MCvhpt()
{
  ...
  TH1D *h7_Jlts   = new TH1D("h7_Jlts",   "2017 MC dimuon lifetime sig", 100, -5, 25);
  ...
  TH1D *h8_Jlts   = new TH1D("h8_Jlts",   "2018 MC dimuon lifetime sig", 100, -5, 25);

  Float_t  ct, ctErr;
  TLorentzVector *mumu_p4 = 0, *muM_p4 = 0, *muP_p4 = 0;

  // 2017 tree
  TFile *fin7 = new TFile("/eos/user/m/maaraujo/JpsiRun2/MC/filtered-all-psi-mc-LOCAL17-veryhighpt.root");
  ...
  TFile *fout7 = new TFile("MCvh17_cuts.root", "recreate");
  h7_muPpT->Write();
  h7_muNpT->Write();
  h7_muPEta->Write();
  h7_muNEta->Write();
  ...
  // 2018 tree
  TFile *fin8 = new TFile("/eos/user/m/maaraujo/JpsiRun2/MC/filtered-all-psi-mc-LOCAL18-veryhighpt.root");
  ...
  TFile *fout8 = new TFile("MCvh18_cuts.root", "recreate");
  h8_muPpT->Write();
  h8_muNpT->Write();
  h8_muPEta->Write();
  h8_muNEta->Write();
