void cosSave()
{
  ...
  TH2D *rNP1Hist_ab = new TH2D("rNP1H_ab", "2018 Data/MC", 20, 0, 1., nPtBins, ptBins);
  rNP1Hist_ab = (TH2D*)NP1Hist_ab->Clone("rNP1H_ab");
  rNP1Hist_ab->Sumw2();
  rNP1Hist_ab->Divide(mcHist_ab);
  rNP1Hist_ab->SetTitle("2018 Data/MC");

  TH2D *rNP2Hist_ab = new TH2D("rNP2H_ab", "2018 Data/MC", 20, 0, 1., nPtBins, ptBins);
  rNP2Hist_ab = (TH2D*)NP2Hist_ab->Clone("rNP2H_ab");
  rNP2Hist_ab->Sumw2();
  rNP2Hist_ab->Divide(mcHist_ab);
  rNP2Hist_ab->SetTitle("2018 Data/MC");
