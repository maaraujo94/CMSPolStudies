...
void plotRes()
{
  ...
  // compare final lambda_th(pT) before and after propagation
  ...
  fl3->SetTitle("2018 #lambda_{#theta} (prompt J/#psi)");
  ...
  legF->AddEntry(graph_lthB, "Before", "pl");
  legF->AddEntry(graph_lth[3], "After", "pl");
  legF->Draw();
