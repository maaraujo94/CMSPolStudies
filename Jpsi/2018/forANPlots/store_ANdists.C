  ...
  for(int i = 0; i < dEvt; i++)
    {
      ...
      // fill the pT histo
      if(data_m > 3.0 && data_m < 3.2 && abs(data_lt) < 0.01 && abs(data_y) < 1.2) {
	h_pT[0]->Fill(data_pt);
      }

      // fill the y histo
      if(data_m > 3.0 && data_m < 3.2 && abs(data_lt) < 0.01) {
	if(data_pt > 25 && data_pt < 46) 
      ...
      // fill the M histo
      if(abs(data_lt) < 0.01 && abs(data_y) < 1.2) {
	if(data_pt > 25 && data_pt < 46) 
	  h_m[0]->Fill(data_m);
	else if(data_pt > 46 && data_pt < 66) 
	  h_m[1]->Fill(data_m);
	...
	if(data_pt > 25 && data_pt < 120) 
      ...
      if(data_m > 3.0 && data_m < 3.2 && abs(data_y) < 1.2 && abs(data_lt) < 0.01) {
	if(data_pt > 25 && data_pt < 46) 
	...
	if(data_pt > 25 && data_pt < 120) 
      ...
      if(data_m > 3.0 && data_m < 3.2 && abs(data_y) < 1.2 && data_lt > 0.014 && data_lt < 0.05) {
	if(data_pt > 25 && data_pt < 46) 
  ...
  for(int i = 0; i < m1Evt; i++)
    {
      ...
      // fill the pT histo
      if(mc_m > 3.0 && mc_m < 3.2 && abs(mc_lt) < 0.01 && abs(mc_y) < 1.2) {
	h_pT[1]->Fill(mc_pt);
      }

      // fill the y histo
      if(mc_m > 3.0 && mc_m < 3.2 && abs(mc_lt) < 0.01) {
	if(mc_pt > 25 && mc_pt < 46) 
	  h_y[3]->Fill(mc_y);
      }

      // fill the m histo
      if(abs(mc_lt) < 0.01 && abs(mc_y) < 1.2) {
	if(mc_pt > 25 && mc_pt < 46) 
	  h_m[3]->Fill(mc_m);
      }

      // fill the costh histo
      if(mc_m > 3.0 && mc_m < 3.2 && abs(mc_y) < 1.2 && abs(mc_lt) < 0.01) {
	if(mc_pt > 25 && mc_pt < 46) {
