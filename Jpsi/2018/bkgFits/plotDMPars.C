...
void plotDMPars(int DO_EXP)
{
  ...
  string parlab[] = {"f", "N", "mu", "sig1", "sig2", "n", "alpha", "p1", "p2", "fBG", "chiN"};
  string partit[] = {"f", "N", "#mu", "#sigma_{1}", "#sigma_{2}", "n", "#alpha", "p_{1}", "p_{2}", "f_{bkg}"};
  string parax[] = {"f (%)", "N", "#mu (GeV)", "#sigma_{1} (GeV)", "#sigma_{2} (GeV)", "n", "#alpha", "p_{1} (GeV^{-1})", "p_{2} (GeV)", "f_{bkg} (%)"};
  double parmin[] = {0,    4e-3, 3.0934, 0.015, 0.03, 1.0, 2.0, 1e2, 3.6, 0.};
  double parmax[] = {100., 5e-3, 3.0944, 0.035, 0.05, 1.4, 2.3, 5e4, 3.8, 10.};
  ...
  TH1F *fl = c->DrawFrame(pt_min, 0, pt_max, 30);
  fl->SetXTitle("p_{T} (GeV)");
