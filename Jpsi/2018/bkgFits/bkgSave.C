...
void bkgSave()
{
  ...
  TH2D *h_d2d = new TH2D("mH", "2018 PR data M(#mu#mu)", mbins, lowm, him, nPtBins, ptBins);
  TH2D *hNP_d2d = new TH2D("mH_NP", "2018 NP data M(#mu#mu)", mbins, lowm, him, nPtBins, ptBins);
  ...
  TH2D *h_d2d_C = new TH2D("mH_C", "2018 PR data M(#mu#mu)", mbins, lowm, him, nPtBins_C, ptBins_C);
