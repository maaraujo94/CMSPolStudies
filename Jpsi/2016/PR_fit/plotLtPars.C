...
void plotLtPars()
{
  ...
  double parmin[] = {8e1, 5e2, 0,  -5., 0,  0,  300};
  double parmax[] = {2e5, 5e5, 100, 5., 20, 40, 400};
  ...
  for(int i = 0; i < n_p; i++) {
    ...
    //fp->SetTitle(Form("2016 %s", partit[i].c_str()));
  ...
  frat->SetTitle("2016 #sigma_{2}/#sigma_{1}");
