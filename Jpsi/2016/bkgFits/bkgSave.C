...
void bkgSave()
{
  ...
  TH2D *h_d2d = new TH2D("mH", "2016 PR data M(#mu#mu)", mbins, lowm, him, nPtBins, ptBins);
  TH2D *hNP_d2d = new TH2D("mH_NP", "2016 NP data M(#mu#mu)", mbins, lowm, him, nPtBins, ptBins);

  // filling all the histos at once    
  // open and read the data tree
  TFile *fin1 = new TFile("/home/mariana/Documents/2020_PhD_work/CERN/CMSPolStudies/Jpsi/Store_data_codes/data16_cos.root");
