...
void plotMMPars()
{
  ...
  double parmin[] = {0,   5e1, 3096,   0.0, 30., 0.6, 1.8};
  double parmax[] = {100, 3e4, 3098,   50., 55., 1.8, 2.5};
  double parmind[] = {60, 5e1, 3096.6, 18., 34., 0.6, 1.8};
  double parmaxd[] = {80, 3e4, 3097.2, 30., 50., 1.8, 2.5};
  ...
  fl->GetYaxis()->SetTitleOffset(1.3);
  fl->GetYaxis()->SetLabelOffset(0.01);
  fl->SetTitle(Form("2017 #chi^{2}/ndf"));
