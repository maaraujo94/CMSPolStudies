...
void bkgSave()
{
  ...
  TH2D *h_d2d = new TH2D("mH", "2017 PR data M(#mu#mu)", mbins, lowm, him, nPtBins, ptBins);
  TH2D *hNP_d2d = new TH2D("mH_NP", "2017 NP data M(#mu#mu)", mbins, lowm, him, nPtBins, ptBins);
  ...
  TH2D *h_d2d_C = new TH2D("mH_C", "2017 PR data M(#mu#mu)", mbins, lowm, him, nPtBins_C, ptBins_C);

  // filling all the histos at once    
  // open and read the data tree
  TFile *fin1 = new TFile("../../Store_data_codes/data17_cos.root");
