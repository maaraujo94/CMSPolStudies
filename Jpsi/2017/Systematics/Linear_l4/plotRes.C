...
void plotRes()
{
  ...
  fl2->SetTitle("2017 #lambda_{#theta} (prompt J/#psi)");
  ...
  TLegend *legF = new TLegend(0.7, 0.75, 0.9, 0.9);
  legF->SetTextSize(0.03);
  legF->AddEntry(graph_lthB, "Constant #lambda_{4}", "pl");
  legF->AddEntry(graph_lth[3], "Linear #lambda_{4}", "pl");
  legF->Draw();
