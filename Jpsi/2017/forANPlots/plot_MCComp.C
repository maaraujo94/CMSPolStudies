...
void plot_MCComp()
{
  ...
  lcy.DrawLatex(-1.1, yl, "#bf{2017 J/#psi}");
  ...
  lcm.DrawLatex(2.95, yl, "#bf{2017 J/#psi}");
  ...
  lcPPt.DrawLatex(45, yl, "#bf{2017 J/#psi}");
  ...
  yl = getPos(hP_pT[0]->GetMinimum(), hP_pT[0]->GetMaximum(), 0.925, 1);
  lcMPt.DrawLatex(45, yl, "#bf{2017 J/#psi}");
  ...
  lcPEta.DrawLatex(-1.2, yl, "#bf{2017 J/#psi}");
  ...
  lcPEtar.DrawLatex(-1.1, yl, "#bf{2017 J/#psi}");
  ...
  yl = getPos(hP_eta[0]->GetMinimum(), hP_eta[0]->GetMaximum(), 0.91, 1);
  lcMEta.DrawLatex(-1.2, yl, "#bf{2017 J/#psi}");
  ...
  lcMEtar.DrawLatex(-1.1, yl, "#bf{2017 J/#psi}");
