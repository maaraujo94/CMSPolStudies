...
void plot_ANdists()
{
  ...
  lcy.DrawLatex(0.875, 1.3e5, "Low-p_{T}");
  lcy.SetTextColor(coly[1]);
  lcy.DrawLatex(0.875, 1.e4, "Mid-p_{T}");
  lcy.SetTextColor(coly[2]);
  lcy.DrawLatex(0.875, 2.e3, "High-p_{T}");
  ...
  lcys.DrawLatex(0.875, 1.3e5, "Low-p_{T}");
  lcys.SetTextColor(coly[1]);
  lcys.DrawLatex(0.875, 1.e4, "Mid-p_{T}");
  lcys.SetTextColor(coly[2]);
  lcys.DrawLatex(0.875, 2.e3, "High-p_{T}");

  lcys.SetTextSize(0.04);
  lcys.SetTextColor(kBlack);
  lcys.DrawLatex(-0.5, 2e5, "rescaled MC");
  lcys.DrawLatex(-0.5, 6e4, "#minus Peak data");
  lcys.DrawLatex(-0.5, 3e4, "--MC");
  ...
  lcmf.DrawLatex(3.15, 6.5e5, "2017 Data");
