...
void plot_muDists()
{
  ...
  lcPPts.DrawLatex(35, yl, "#bf{2017 J/#psi}");
  ...
  lcMPts.DrawLatex(35, yl, "#bf{2017 J/#psi}");
  ...
  lcPEtas.DrawLatex(-1.25, yl, "#bf{2017 J/#psi}");
  ...
  lcPEtar.DrawLatex(-1.22, yl, "#bf{2017 J/#psi}");
  ...
  lcMEtas.DrawLatex(-1.25, yl, "#bf{2017 J/#psi}");
  ...
  lcMEtar.DrawLatex(-1.22, yl, "#bf{2017 J/#psi}");
