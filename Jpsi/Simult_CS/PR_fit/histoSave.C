...
void histoSave()
{
  ...
  TFile *fin = new TFile("../../Store_data_codes/dataS_cosCS.root");
  TTree *treeD = (TTree*)fin->Get("data_cos");
  TFile *fin1 = new TFile("../../Store_data_codes/MCS_cosCS.root");
  TTree *treeM1 = (TTree*)fin1->Get("MC_cos");
  TFile *fin2 = new TFile("../../Store_data_codes/MCmS_cosCS.root");
  TTree *treeM2 = (TTree*)fin2->Get("MC_cos");
  TFile *fin3 = new TFile("../../Store_data_codes/MChS_cosCS.root");
  TTree *treeM3 = (TTree*)fin3->Get("MC_cos");
  TFile *fin4 = new TFile("../../Store_data_codes/MCvhS_cosCS.root");
