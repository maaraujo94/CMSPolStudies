...
void plotRes()
{
  ...
  leg->AddEntry(graph_lth[0], "#lambda_{#theta}^{HX}", "pl");
  leg->AddEntry(graph_lth[1], "#lambda_{#phi}^{HX}", "pl");
  leg->AddEntry(graph_lth[2], "#lambda_{#theta#phi}^{HX}", "pl");
  leg->Draw();
