// get lambda_tilde from 3 diff sources for PR case
...
void lbdTil()
{
  ...
  // now get the 2d HX
  TFile *fInd_HX = new TFile("../PR_fit/files/finalFitRes.root");
  ...
  // now w/o ltp
  TFile *fInd_HXz = new TFile("../PR_fit/files/finalFitRes_ltpz.root");
  ...
  // now get the 2d CS
  TFile *fInd_CS = new TFile("../../Simult2d_CS/PR_fit/files/finalFitRes.root");
  ...
  // now w/o ltp
  TFile *fInd_CSz = new TFile("../../Simult2d_CS/PR_fit/files/finalFitRes_ltpz.root");
