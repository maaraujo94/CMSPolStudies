...
void plotRes()
{
  ...
  TFile *fIndB = new TFile("../../Simult/PR_fit/files/finalFitRes.root");
  TGraphErrors *graph_lthB = new TGraphErrors();
  graph_lthB = (TGraphErrors*)fIndB->Get(Form("graph_lambda_J"));
  fIndB->Close();
