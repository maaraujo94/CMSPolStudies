...
void newMCmass_2()
{
  ...
  if(DO_FILL == 1) {
    ...
    TFile *fin1 = new TFile("/home/mariana/Documents/2020_PhD_work/CERN/CMSPolStudies/Jpsi/Store_data_codes/MCS_old_cos.root");
  ...
  TFile *fout = new TFile("files/MCfit_2.root", "recreate");
  h_m2d->Fit("f_cb", "R");
  ...
  ofstream ftex;
  ftex.open("text_output/mfit_MC_2.tex");
