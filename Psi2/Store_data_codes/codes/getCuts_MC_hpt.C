...
void getCuts_MC_hpt()
{
  ...
  TH1D *h7_JMass  = new TH1D("h7_JMass",  "2017 MC dimuon mass",         100, 3.35, 4);
  TH1D *h7_JPt    = new TH1D("h7_JPt",    "2017 MC dimuon pT",           100, 0, 200);
  TH1D *h7_Jy     = new TH1D("h7_Jy",     "2017 MC dimuon y",            100, -2, 2);
  ...
  TH1D *h8_JMass  = new TH1D("h8_JMass",  "2018 MC dimuon mass",         100, 3.35, 4);
  TH1D *h8_JPt    = new TH1D("h8_JPt",    "2018 MC dimuon pT",           100, 0, 200);
  TH1D *h8_Jy     = new TH1D("h8_Jy",     "2018 MC dimuon y",            100, -2, 2);
