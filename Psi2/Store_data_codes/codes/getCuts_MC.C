...
void getCuts_MC()
{
  ...
  tree->Add("/eos/user/m/maaraujo/Psi2SRun2/filtered-all-psi2s-mc-LOCAL18.root");
  ...
  TH1D *h_muPpT  = new TH1D("h_muPpT",  "MC muon pT",    100, 0, 150);
  TH1D *h_muNpT  = new TH1D("h_muNpT",  "muonN pT",      100, 0, 150);
  TH1D *h_muPEta = new TH1D("h_muPEta", "MC muon eta",   100, -2, 2);
  TH1D *h_muNEta = new TH1D("h_muNEta", "muonN eta",     100, -2, 2);
  TH1D *h_JMass  = new TH1D("h_JMass",  "MC Psi2S mass", 100, 3.35, 4);
  TH1D *h_JPt    = new TH1D("h_JPt",    "MC Psi2S pT",   100, 0, 200);
  TH1D *h_Jy     = new TH1D("h_Jy",     "MC Psi2S y",    100, -2, 2);
  TH1D *h_Jlts   = new TH1D("h_Jlts",   "MC Psi2S lts",  100, -5, 25);
  ...
  TFile *outfile = new TFile("Psi2_MC_cuts.root", "recreate");
  h_muPpT->Write();
  h_muNpT->Write();
  h_muPEta->Write();
  h_muNEta->Write();
