...
void plot_ANdists()
{
  ...
  lcpt.DrawLatex(120, 1.5e6, "Peak data");
  lcpt.SetTextColor(colpt[1]);
  lcpt.DrawLatex(120, 6.5e5, "MC low p_{T}");
  lcpt.SetTextColor(colpt[2]);
  lcpt.DrawLatex(120, 2.5e5, "MC high p_{T}");
  ...
  lcy.DrawLatex(0.875, 1.e5, "Low-p_{T}");
  lcy.SetTextColor(coly[1]);
  lcy.DrawLatex(0.875, 3e3, "High-p_{T}");
  ...
  lcy.SetTextColor(coly[0]);
  lcy.DrawLatex(0.875, 2.e4, "Low-p_{T}");
  lcy.SetTextColor(coly[1]);
  lcy.DrawLatex(0.875, 3e3, "High-p_{T}");

  lcys.SetTextSize(0.04);
  lcys.SetTextColor(kBlack);
  lcys.DrawLatex(-0.5, 1e5, "rescaled MC");
  lcys.DrawLatex(-0.5, 6e4, "#minus Peak data");
  lcys.DrawLatex(-0.5, 3.5e4, "--MC");
  ...
  h_lt[2]->SetMinimum(1e2);
  h_lt[2]->SetMaximum(4e5);
  ...
  lcltf.DrawLatex(300, 1.5e5, "Run 2 Data");
  ...
  lclts.DrawLatex(300, 1.5e5, "Data:");
  lclts.DrawLatex(-40, 2e2, "Peak");
  lclts.DrawLatex(275, 2e2, "NP");
  
  lclts.SetTextColor(colpt[1]);
  lclts.DrawLatex(300, 9e4, "low p_{T}");
  lclts.SetTextColor(colpt[2]);
  lclts.DrawLatex(300, 5e4, "high p_{T}");  
  ...
  lcm.DrawLatex(3.75, 0.03, "low-p_{T}");
  lcm.SetTextColor(coly[1]);
  lcm.DrawLatex(3.75, 0.027, "high-p_{T}");
  lcm.SetTextColor(kBlack);
  lcm.DrawLatex(3.4, 0.03, "#minus Data");
  lcm.DrawLatex(3.4, 0.027, "--MC");
  ...
  lcmf.DrawLatex(3.75, 5e4, "Full Data");
