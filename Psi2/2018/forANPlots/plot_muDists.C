...
void plot_muDists()
{
  ...
  legPPts->AddEntry(hP_pT[0], "PRS Data", "pl");
  legPPts->AddEntry(hP_pT[1], "MC", "pl");
  legPPts->Draw();

  TLatex lcPPts;
  lcPPts.SetTextSize(0.04);
  double yl = getPos(hP_pT[0]->GetMinimum(), hP_pT[0]->GetMaximum(), 0.9, 1);
  lcPPts.DrawLatex(25, yl, "#bf{2018 #psi(2S)}");
  ...
  lcMPts.DrawLatex(25, yl, "#bf{2018 #psi(2S)}");
  ...
  legPEtas->AddEntry(hP_eta[0], "PRS Data", "pl");
  legPEtas->AddEntry(hP_eta[1], "Scaled MC", "pl");
  legPEtas->Draw();

  TLatex lcPEtas;
  lcPEtas.SetTextSize(0.04);
  yl = getPos(hP_eta[0]->GetMinimum(), hP_eta[0]->GetMaximum(), 0.9, 1);
  lcPEtas.DrawLatex(-1.25, yl, "#bf{2018 #psi(2S)}");
  ...
  lcPEtar.DrawLatex(-1.22, yl, "#bf{2018 #psi(2S)}");
  yl = getPos(hP_etar[0]->GetMinimum(), hP_etar[0]->GetMaximum(), 0.9, 0);
  ...
  lcMEtas.DrawLatex(-1.25, yl, "#bf{2018 #psi(2S)}");
  ...
  lcMEtar.DrawLatex(-1.22, yl, "#bf{2018 #psi(2S)}");
  yl = getPos(hM_etar[0]->GetMinimum(), hM_etar[0]->GetMaximum(), 0.9, 0);
