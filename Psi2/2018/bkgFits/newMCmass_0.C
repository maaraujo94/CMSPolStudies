...
void newMCmass_0()
{
  ...
  if(DO_FILL == 1) {
    ...
    TFile *fin1 = new TFile("/home/mariana/Documents/2020_PhD_work/CERN/CMSPolStudies/Psi2/Store_data_codes/MC18_cos.root");
    TTree *tree1 = (TTree*)fin1->Get("MC_cos");
    TFile *fin3 = new TFile("/home/mariana/Documents/2020_PhD_work/CERN/CMSPolStudies/Psi2/Store_data_codes/MCvh18_cos.root");
