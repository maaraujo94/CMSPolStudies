...
void newMCmass_0()
{
  ...
  if(DO_FILL == 1) {
    ...
    tree3->SetBranchAddress("muonPPt", &mP_pt);
    tree3->SetBranchAddress("muonPEta", &mP_eta);
    tree3->SetBranchAddress("muonMPt", &mM_pt);
    tree3->SetBranchAddress("muonMEta", &mM_eta);
