...
void plotLtPars()
{
  ...
  double parmin[] = {1e1, 4e1, 0,  -5., 0,  0,  300};
  double parmax[] = {5e3, 2e4, 100, 5., 20, 40, 400};
  ...
  TH1F *fchi = c->DrawFrame(pt_min[0]-5, 0, pt_max[pt_bins-1]+5, 5);
