...
void plot_ANdists()
{
  ...
  lcy.DrawLatex(0.875, 1.e4, "Low-p_{T}");
  lcy.SetTextColor(coly[1]);
  lcy.DrawLatex(0.875, 1.2e3, "High-p_{T}");
  ...
  lcys.DrawLatex(0.875, 1.e4, "Low-p_{T}");
  lcys.SetTextColor(coly[1]);
  lcys.DrawLatex(0.875, 1.2e3, "High-p_{T}");

  lcys.SetTextSize(0.04);
  lcys.SetTextColor(kBlack);
  lcys.DrawLatex(-0.5, 1.e4, "rescaled MC");
  lcys.DrawLatex(-0.5, 5.7e3, "#minus Peak data");
  lcys.DrawLatex(-0.5, 4e3, "--MC");
  ...
  lcltf.DrawLatex(300, 2e5, "2017 Data");
  ...
  lcm.DrawLatex(3.4, 0.032, "#minus Data");
  lcm.DrawLatex(3.4, 0.029, "--MC");
  ...
  lcmf.DrawLatex(3.8, 3e4, "2017 Data");
