...
void plotCosFit()
{
  ...
  for(int i = 0; i < nBinsY; i++) {
    ...
    lcr1.DrawLatex(0.7, h_rat1d[0][i]->GetMaximum()*0.9, "2017");
    ...
    lcr3.DrawLatex(0.7, h_rat1d[0][i]->GetMaximum()*0.9, "2017");
    ...
    lcr3.DrawLatex(0.15, h_rat1d[3][i]->GetMaximum()*0.7, "#psi(2S)/MC");
