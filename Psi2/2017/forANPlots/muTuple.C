...
void muTuple()
{
  ...
  // data tree
  TFile *finD = new TFile("/home/mariana/Documents/2020_PhD_work/CERN/CMSPolStudies/Psi2/Store_data_codes/orig_files/filtered-all-psi2s-UL17.root");
  ...
  TFile *finM1 = new TFile("/home/mariana/Documents/2020_PhD_work/CERN/CMSPolStudies/Psi2/Store_data_codes/orig_files/filtered-all-psi2s-mc-LOCAL17-midpt-v1.root");
