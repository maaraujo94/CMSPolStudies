...
void ratioSave()
{
  ...
  for(int i_w = 0; i_w < 3; i_w++) {
    dataHist[i_w] = new TH2D(Form("dataH_%s", wname[i_w].c_str()), Form("2017 Data (PR) %s", wtit[i_w].c_str()), 40, -1., 1., nPtBins, ptBins);
    mcHist[i_w] = new TH2D(Form("mcH_%s", wname[i_w].c_str()), Form("2017 MC %s", wtit[i_w].c_str()), 40, -1., 1., nPtBins, ptBins);
    
    dataHist_ab[i_w] = new TH2D(Form("dataH_ab_%s", wname[i_w].c_str()), Form("2017 Data (PR) %s", wtit[i_w].c_str()), 20, 0, 1., nPtBins, ptBins);
    mcHist_ab[i_w] = new TH2D(Form("mcH_ab_%s", wname[i_w].c_str()), Form("2017 MC %s", wtit[i_w].c_str()), 20, 0, 1., nPtBins, ptBins);
  }
  ...
  for(int i_w = 0; i_w < 3; i_w++) {
    ...
    ratioHist_ab[i_w]->SetTitle(Form("2017 %s/MC", wtit[i_w].c_str()));
